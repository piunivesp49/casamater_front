...
const Especiais = () => {
  ...
  const fetchEspeciais = () => {
    fetch("https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app")
  ...
  const handleSave = async () => {
    try {
      await Promise.all(
        especiais.map((item) =>
          fetch(`https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app/api/especiais/${item.id}`, {
            method: "PUT",
