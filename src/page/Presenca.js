...
function Presenca() {
  ...
  const buscarPresencas = async () => {
    try {
      const response = await fetch('https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app/api/presenca');
  ...
  const handleSubmit = async (e) => {
    ...
    const url = form.id
      ? `https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app/api/presenca/${form.id}`
      : 'https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app/api/presenca';
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Deseja apagar esta presença?')) {
      await fetch(`https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app/api/presenca/${id}`, {
        method: 'DELETE'
      });
      buscarPresencas();
    }
  ...
  const handleImport = async () => {
    try {
      const response = await fetch('https://539a-2804-7f0-6540-600f-1d00-d9b7-d6cb-da39.ngrok-free.app/api/presenca/importar', {
        method: 'POST'
      });
      if (response.ok) {
